...
export default function NewsletterCTA() {
  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-gradient-to-r from-pink-50 to-orange-50 rounded-2xl p-8 text-center border border-pink-200">
        <div className="text-3xl mb-3">📬</div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          <input
            ...
            required
            className="flex-1 px-4 py-3 rounded-xl border border-slate-200 text-base focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent"
          />
          <button
            type="submit"
            disabled={submitting}
            className="px-6 py-3 bg-pink-400 text-white font-semibold rounded-xl hover:bg-pink-500 transition border-0 cursor-pointer text-base disabled:opacity-50"
          >
            {submitting ? "處理中..." : "訂閱"}
          </button>
        </form>
