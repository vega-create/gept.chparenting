...
const FAQ_ITEMS = [
  ...
  {
    q: "平台上有哪些學習內容？",
    a: "目前提供七大學習工具：① 全民英檢（94 個單元，涵蓋 8,000+ 單字，初級・中級・中高級完整聽說讀寫練習）；② JLPT 日文檢定（N5～N1 全 5 個級別，每級 20 單元共 100 單元）；③ 教育桌遊（18 款遊戲，包含邏輯、程式概念、記憶力、反應力、數學、語言、圍棋、跳棋等類別）；④ 打字練習（中英雙語打字訓練）；⑤ 數學練習（8 大主題，觀念教學 + 互動練習 + 限時挑戰）；⑥ 兒童理財（6 個互動模組，認識金錢、儲蓄計算、零用錢分配等）。",
  },
  {
    q: "可以在手機上使用嗎？",
  ...
  {
    q: "內容會更新嗎？",
    a: "會！我們持續在新增內容和改善功能。目前英檢、日文 N5～N1、教育桌遊（含圍棋跳棋）、打字練習、數學練習和兒童理財都已上線。更多優質內容持續規劃中！",
  },
  {
    q: "如何回報問題或建議？",
