...
const TOOLS = [
  ...
  {
    id: "japanese", title: "日文檢定", sub: "JLPT N5–N4", icon: "🇯🇵",
    desc: "五十音到 N4 完整日文學習",
    color: "from-red-400 to-red-500", border: "border-red-200",
    active: true, href: "/jlpt-n5",
    features: ["五十音教學", "N5 + N4 完整上線", "聽力閱讀練習", "JLPT 模擬測驗"],
  },
  {
    ...
    features: ["邏輯推理遊戲", "程式碼概念入門", "記憶力訓練", "反應力挑戰"],
  },
  {
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 relative">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="/board-games" className="px-8 py-3 bg-white text-orange-600 rounded-xl font-bold text-lg hover:bg-orange-50 transition shadow-lg hover:shadow-xl no-underline">
                🎲 玩桌遊
              </a>
