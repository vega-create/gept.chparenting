    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 text-white">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-blue-100 text-sm">持續學習，每天進步一點點</p>
          </div>
          {streak && streak.current_streak > 0 && (
            <div className="flex items-center gap-3 bg-white/15 rounded-xl px-5 py-3">
              ...
              <div>
                ...
                <div className="text-xs text-blue-200">連續學習</div>
              </div>
              {streak.longest_streak > streak.current_streak && (
                <div className="text-xs text-blue-200 border-l border-white/20 pl-3 ml-1">
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="/dashboard/schedule" className="text-sm text-blue-500 hover:underline no-underline">編輯計畫 →</a>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-6">
            ...
            <a href="/dashboard/schedule" className="text-sm text-blue-500 font-medium hover:underline no-underline">
              前往設定 →
            </a>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  {done ? (
                    ...
                    <span className="text-xs text-blue-400 font-medium">開始 →</span>
                  )}
                </a>
              );
            })}
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm text-center">
          <div className="text-3xl font-black text-blue-600">{isLoading ? "-" : weekStats.count}</div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="/dashboard/records" className="text-sm text-blue-500 hover:underline no-underline">查看全部 →</a>
        </div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          <a href="/elementary" className="px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold text-sm hover:bg-blue-700 transition no-underline">📘 英檢</a>
