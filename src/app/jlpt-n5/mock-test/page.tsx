      ...
      <div className="max-w-lg mx-auto px-4 py-10 text-center">
        <div className="bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-lg">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <a href="/jlpt-n5" className="px-6 py-2.5 rounded-xl border-2 border-blue-600 text-blue-600 font-semibold text-sm no-underline hover:bg-blue-50 transition">← 返回</a>
          </div>
        </div>
      </div>
    );
